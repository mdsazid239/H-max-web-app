...
import exchangeImage from "../assets/images/exchange-1.png";
import currencyImage from "../assets/images/exchange-2.png";
import currentImage from "../assets/images/exchange-3.png";
    ...
    <div>
      {SERVICE_BANNERS.map((banner, index) => (
        <Link
          key={banner.title}
          to={banner.to}
          className={`group relative flex min-h-[260px] items-center justify-center overflow-hidden bg-gradient-to-br px-6 py-20 text-center sm:min-h-[320px] lg:min-h-[380px] ${
            BANNER_BACKGROUNDS[index % BANNER_BACKGROUNDS.length]
          }`}
        >
          <img
            src={BANNER_IMAGES[index % BANNER_IMAGES.length]}
            alt=""
